...
function aboutMe(){
    ...
    if(i==0){
        ...
        slogan2.innerHTML="这里是梁布斯同学~ 这个废柴能熟练掌握面向百度编程、Windows和Linux的开关机、PS和PR的安装和卸载、WordPress各种主题和插件的安装和魔改。。。生命不息，折腾不止！目前坐等中考中...";
    } else {
        i=0;
        slogan.style.height="50px";
        slogan2.innerHTML="May all the beauty be blessed. ———— 《Moon Halo》";
    }
